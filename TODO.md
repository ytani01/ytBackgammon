...
**残っている項目: TODO-036 の 1 件。** これまでに 35 件を決着させた。
...
- [ ] `README.md` と `docs/Player.md` / `Admin.md` / `Developer.md` を読み直し、
      不自然な日本語を直す
- [ ] コマンド・手順・事実関係を変えていないことを確かめる

### きっかけ

TODO-033 で 3 つの文書を新しく書き、`README.md` も直した。中身は確認済みだが、
**書いたのが Claude なので、言い回しが不自然なところが残っている。**

### 決めたこと

- **直すのは言い回しだけ。** コマンド、手順、オプションの説明、リンク、
  画像の参照、事実関係は変えない
