...
**残っている項目: TODO-031,TODO-032,TODO-033 の 2 件。** これまでに 30 件を決着させた。
...
## TODO-033. README.md, docs/User.md docs/Developer.md を整備

- README.md: このプログラムの特徴をアピール
- User.md: 利用者向けに、tmrコマンドの使い方説明
- Developer.md: 本プロジェクトの開発者向けに、内部構造の説明
